...
export const HeroBlock = ({ data }: HeroBlockProps) => {
  ...
  const secondaryButtonText = additionalData?.secondaryButtonText;
  const secondaryButtonLink = additionalData?.secondaryButtonLink;
    ...
    >
      <div className="container mx-auto px-4 md:px-8 lg:px-16 relative z-10">
        <div className="flex flex-col md:flex-row items-center justify-between gap-12 md:gap-16">
          <div
            className={`w-full space-y-6 md:self-center ${
              layout === "service"
                ? "md:w-full text-center"
                : "md:w-[45%] text-center md:text-left"
            }`}
          >
            ...
            {/* Conditional tagline for service hero layout */}
            {layout === "service" && tagline && (
              <div className="flex items-center justify-center md:justify-start gap-2 text-[var(--color-deep-slate)] font-medium">
                <div className="w-8 h-8 flex items-center justify-center">
                  {/* Icon placeholder - you can replace with your brand icon */}
                  <div className="w-6 h-6 bg-[var(--color-primary)] rounded" />
                </div>
                <span>{tagline}</span>
              </div>
            )}
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
              ...
              {/* Secondary button for service layout */}
              {layout === "service" &&
                secondaryButtonText &&
                secondaryButtonLink && (
                  <a
                    href={secondaryButtonLink}
                    className="px-8 py-3 rounded-xl border-2 border-[var(--color-primary)] text-[var(--color-primary)] font-medium transition-colors hover:bg-[var(--color-primary)] hover:text-[var(--color-deep-slate)]"
                  >
                    {secondaryButtonText}
                  </a>
                )}
